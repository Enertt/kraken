        ...
        <LoginLayout heading=' '>
            <div className={styles.block}>
                ...
                <div className={styles.text}>
                    <p>
                        Thanks! You have successfully registered on our service! Now you can
                        use the great features of the KRAKEN project!
                    </p>
                </div>
                ...
                <div className={styles.button}>
                    <Button clickHandler={() => navigate('/login')}>Use the site</Button>
                </div>
            </div>
        </LoginLayout>
    )
